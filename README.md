...
All EMBEDDIA Toolkit components are packaged as Docker images available in our registry. For downloading and running the images following commands must be executed:
