...
COMMENT_ANALYZERS = {
    ...
    "Comment Moderator BERT (Estonian, English, Latvian, Lithuanian, Russian)": BERTTaggerAnalyzer(host=TEXTA_HOST, auth_token=TEXTA_TOKEN, pipeline=TEXTA_BERT_TAGGER, ssl_verify=SSL_VERIFY)
}
